...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-2dmpoyq-p(x9)t)7st6^xxaz9%=v_gzv=ig1+yd2f-$m14k=$j')
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # ИЛИ: BASE_DIR / 'staticfiles'
...
#EMAIL_PORT = 587
#EMAIL_USE_TLS = True
#EMAIL_HOST_USER = 'egere701@gmail.com'  # Ваш email
#EMAIL_HOST_PASSWORD = 'qwerty'  # Пароль
